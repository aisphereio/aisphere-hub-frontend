...
import {
  ...
  Plus, Trash2, Save, Pencil, X, Check, Search, RefreshCw,
} from 'lucide-react';
...
import type { LocalUser, IamCpOrganization, IamProject, IamGrant, IamSubjectRef, IamResourceRef } from '@/lib/api/types';

// ─── Tab Configuration ─────────────────────────────────────────────────

type IamTab = 'local-users' | 'organizations' | 'projects' | 'grants' | 'resources';
