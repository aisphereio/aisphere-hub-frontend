...
const en: Dict = {
  ...
  'form.modelType': 'Model Type',
  'form.modelFamily': 'Model Family',
  'form.modelFamilyHint': 'Select a family to load its protocol and reasoning controls.',
  ...
  'form.reasoning': 'Reasoning Configuration',
  'form.reasoningHint': '{model} uses model-specific reasoning parameters.',
  'form.enableReasoning': 'Enable reasoning',
...
const zh: Dict = {
  ...
  'form.modelType': '模型类型',
  'form.modelFamily': '模型家族',
  'form.modelFamilyHint': '选择模型家族后，会自动加载协议和推理配置。',
  'form.description': '描述',
  'form.status': '状态',
  'form.provider': '供应商',
  ...
  'form.reasoning': '推理配置',
  'form.reasoningHint': '{model} 使用该模型专属的推理参数。',
  'form.enableReasoning': '开启推理',
